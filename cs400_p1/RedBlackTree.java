...
public class RedBlackTree<T extends Comparable<T>> implements SortedCollectionInterface<T> {
    ...
    public static boolean test1() {
    	...
    	try {
            ...
            // Expected level order traversal: 4, 5, 6
            String levelOrder = tree.toLevelOrderString();
            return levelOrder.equals("[ 4, 5, 6 ]");
        } catch (Exception e) {
            e.printStackTrace();
            return false;
        }
    ...
    public static boolean test2() {
    	...
    	try {
            ...
            // Rotate around 3 and 2
            Node<Integer> node3 = tree.findNodeWithData(3);
            Node<Integer> node2 = tree.findNodeWithData(2);
            tree.rotate(node3, node2);

            // Expected level order traversal: 4, 3, 6, 2, 5, 7, 1
            String levelOrder = tree.toLevelOrderString();
            return levelOrder.equals("[ 4, 3, 6, 2, 5, 7, 1 ]");
        } catch (Exception e) {
            e.printStackTrace();
            return false;
        }
    ...
    public static boolean test3() {
    	try {
            ...
            // Rotate around 4 and 2
            Node<Integer> node4 = tree.findNodeWithData(4);
            Node<Integer> node2 = tree.findNodeWithData(2);
            tree.rotate(node2, node4);

            // Expected level order traversal: 2, 1, 4
            String levelOrder = tree.toLevelOrderString();
            return levelOrder.equals("[ 2, 1, 4 ]");
        } catch (Exception e) {
            e.printStackTrace();
            return false;
        }
